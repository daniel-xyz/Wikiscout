<template>
  <header>
    ...
    <nav id="main-nav">
      <div class="hide-md-and-up menu-toggle-icon" @mouseover="menuExpanded = true" @mouseout="menuExpanded = false">
        <ul v-show="menuExpanded">
          <li @click="menuExpanded = false"><router-link :to="{ path: '/data' }">Datenschutz</router-link></li>
          <li @click="menuExpanded = false"><router-link :to="{ path: '/imprint' }">Impressum</router-link></li>
        </ul>
      </div>
